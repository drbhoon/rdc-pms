...
function QuestionField({ question, value, onChange, disabled, rmValue }) {
    ...
    return (
      <div>
        <select
          ...
          disabled={disabled}
          className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:bg-slate-50 disabled:text-slate-500 transition-all"
        >
  ...
  if (fieldType === 'narrative') {
    return (
      <textarea
        ...
        className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:bg-slate-50 disabled:text-slate-500 resize-y transition-all"
      />
    );
  }
  if (fieldType === 'number') {
    return (
      <input
        ...
        className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:bg-slate-50 disabled:text-slate-500 transition-all"
      />
    );
  }
  if (fieldType === 'date') {
    return (
      <input
        ...
        onChange={(e) => onChange(key, e.target.value)}
        disabled={disabled}
        className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-800 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 disabled:bg-slate-50 disabled:text-slate-500 transition-all"
      />
    );
  }
  return null;
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 py-8">
        ...
        {submitted ? (
          <div className="bg-white rounded-2xl border border-green-200 shadow-sm px-8 py-12 text-center">
            ...
            <p className="text-slate-500 text-sm">Thank you for completing the BH assessment. You may close this window.</p>
          </div>
        ) : (
